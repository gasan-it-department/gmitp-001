...
it('assigns every admin action center route to one explicit capability', function () {
    $expectedCapabilities = [
        ...
        'actionCenter.admin.household.profile' => 'action_center.beneficiaries.view',
        'actionCenter.admin.household.beneficiaries.create' => 'action_center.beneficiaries.manage',
        ...
        'actionCenter.admin.assistance.create' => 'action_center.requests.intake',
        ...
        'actionCenter.assistance.start-review' => 'action_center.requests.verify',
        'actionCenter.assistance.update' => 'action_center.requests.intake|action_center.requests.process',
        'actionCenter.assistance.documents.upload' => 'action_center.requests.intake|action_center.requests.process',
        'actionCenter.assistance.additional-document.replace' => 'action_center.requests.intake|action_center.requests.process',
        'actionCenter.assistance.document-check.update' => 'action_center.requests.verify',
        'actionCenter.assistance.mswd.complete' => 'action_center.requests.verify',
        'actionCenter.assistance.mswd.return' => 'action_center.requests.verify',
        ...
        'actionCenter.assistance.cooldown-context' => 'action_center.requests.decide|action_center.requests.release',
        ...
        'actionCenter.assistance.disbursement.save' => 'action_center.requests.disburse',
        'actionCenter.assistance.disbursement.ready' => 'action_center.requests.disburse',
        'actionCenter.assistance.disbursement.retry-notification' => 'action_center.requests.disburse',
        'actionCenter.assistance.disbursement.manual-contact' => 'action_center.requests.disburse',
        'actionCenter.assistance.disbursement.void' => 'action_center.requests.disburse',
        ...
        'actionCenter.beneficiary.identity-document.replace' => 'action_center.beneficiaries.manage|action_center.beneficiaries.verify',
        ...
        'actionCenter.household.members.store-admin' => 'action_center.beneficiaries.manage',
        'actionCenter.household.beneficiaries.store' => 'action_center.beneficiaries.manage',
        'actionCenter.household.beneficiary-candidates.index' => 'action_center.beneficiaries.correct',
        'actionCenter.household.beneficiary-candidates.transfer-context' => 'action_center.beneficiaries.correct',
