...
class GenerateObligationRequestController extends Controller
{
    public function __construct(
        private readonly GenerateObligationRequestAction $generate,
        private readonly ObligationRequestPdf $pdf,
    ) {}
    ...
    public function __invoke(
        ...
        try {
            $dto = GenerateObligationRequestDto::fromRequest(
                request: $request,
            ...
            return response()->json([
                'message' => 'The Obligation Request could not be generated. Please review the form and try again.',
            ], 500);
        }
    }
}
