...
class GenerateFinancialDocumentPacketController extends Controller
{
    public function __construct(
        private readonly GenerateFinancialDocumentPacketAction $generate,
        private readonly FinancialDocumentPacketPdf $pdf,
    ) {}
    ...
    public function __invoke(
        ...
        try {
            $dto = GenerateFinancialDocumentPacketDto::fromRequest(
                request: $request,
            ...
            return response()->json([
                'message' => 'The financial document packet could not be generated. Please review the form and try again.',
            ], 500);
        }
    }
}
