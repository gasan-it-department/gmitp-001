...
class ShowAssistanceRequestIntakeSheetGeneratorController extends Controller
{
    ...
    public function __invoke(
        ...
        try {
            ...
            return Inertia::render(
                'ActionCenter/Admin/RequestDetails/AssistanceRequestIntakeSheetGenerator',
                ['assistanceRequestIntakeSheet' => $form->toArray()],
            );
            ...
            return redirect()
                ...
                ->withErrors(['intake_sheet' => $e->getMessage()]);
        }
    }
}
