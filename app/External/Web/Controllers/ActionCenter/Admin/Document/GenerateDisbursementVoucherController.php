...
class GenerateDisbursementVoucherController extends Controller
{
    public function __construct(
        private readonly GenerateDisbursementVoucherAction $generate,
        private readonly DisbursementVoucherPdf $pdf,
    ) {}
    ...
    public function __invoke(
        ...
        try {
            $dto = GenerateDisbursementVoucherDto::fromRequest(
                request: $request,
            ...
            return response()->json([
                'message' => 'The Disbursement Voucher could not be generated. Please review the form and try again.',
            ], 500);
        }
    }
}
