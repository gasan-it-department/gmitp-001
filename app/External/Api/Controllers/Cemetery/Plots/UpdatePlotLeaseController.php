...
use App\Core\Cemetery\Actions\Plots\UpdatePlotLeaseAction;
...
class UpdatePlotLeaseController extends Controller
{
    public function __construct(
        private UpdatePlotLeaseAction $updatePlotLease,
    ) {}

    public function __invoke(UpdatePlotLeaseRequest $request, string $cemetery_site_id, string $plot_id): RedirectResponse
    {
        $lease = $this->updatePlotLease->execute(
        ...
        ])->with('success', 'Plot lease updated.');
    }
}
