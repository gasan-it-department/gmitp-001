        ...
        <PublicLayout title="Action Center ng MSWD" description="Mga Serbisyo at Tulong Panlipunan para sa Komunidad">
            ...
            <section className="relative overflow-hidden bg-gradient-to-b from-orange-50/40 via-background to-background px-4 py-20 md:py-32 dark:from-orange-950/10">
                ...
                <div className="relative z-10 mx-auto max-w-4xl space-y-8 text-center">
                    ...
                    <p className="mx-auto max-w-2xl text-lg leading-relaxed font-medium text-muted-foreground md:text-xl">
                        Ang Municipal Action Center ng MSWD ay laging handang maghatid ng tulong para sa ating mga kababayan. Pumili sa mga programa
                        sa ibaba upang makapagsimula ng inyong aplikasyon.
                    </p>
                </div>
            </section>
            ...
            <section className="container mx-auto max-w-6xl px-4 py-20">
                ...
                {activeAssistance.length === 0 ? (
                    <div className="flex flex-col items-center justify-center rounded-3xl border-2 border-dashed border-muted bg-card/40 p-16 text-center">
                        <ShieldCheck className="mb-4 h-12 w-12 text-muted-foreground/40" />
                        <p className="text-lg font-medium text-muted-foreground">
                            Kasalukuyang walang aktibong mga programa ng tulong sa inyong munisipyo.
                        </p>
                    </div>
                ) : (
