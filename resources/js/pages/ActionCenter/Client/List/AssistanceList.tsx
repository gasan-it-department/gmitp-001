                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div className="flex flex-col">
                                    <div className="flex items-center gap-3">
                                        <h3 className="text-xl font-black uppercase tracking-widest text-foreground hidden sm:block">My Requests</h3>
                                        <h3 className="text-xl font-black uppercase tracking-widest text-foreground sm:hidden">Requests</h3>
                                                ...
                                                <div className="mb-4">
                                                    ...
                                                    <div className="mt-3 space-y-2">
                                                        ...
                                                        <div className="flex items-center gap-2 text-sm text-muted-foreground">
                                                            ...
                                                            <span className={`${req.amount_approved ? 'font-bold text-green-600' : 'text-muted-foreground italic'}`}>
