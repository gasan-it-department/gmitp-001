...
export default function ReportDetails({ report }: ReportDetailsProps) {
    ...
    const canReview = report.status.value === 'pending';
    const canStart = report.status.value === 'pending' || report.status.value === 'reviewed';
    const canResolve = !isTerminal;
    const canReject = !isTerminal;

    const todo = (label: string) => () => {
        // Mutation endpoints land in Phase 4. Scaffolded only.
        // eslint-disable-next-line no-console
        console.warn(`TODO: wire endpoint for "${label}" on report ${report.id}`);
    };
                ...
                <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
                    ...
                    <div className="space-y-6 lg:col-span-2">
                        ...
                        <Card className="shadow-sm">
                            <CardHeader>
                                <p className="text-xs uppercase tracking-wide text-slate-500">{report.category.label}</p>
                    ...
                    <div className="space-y-6">
                            ...
                            <CardHeader>
                                ...
                                <p className="text-xs text-slate-500">
                                    ...
                                    <span className="block italic text-amber-600">
                                        Action wiring lands in Phase 4 — buttons are scaffolded.
                                    </span>
                                </p>
                            </CardHeader>
                        ...
                        <Card className="shadow-sm">
                            <CardHeader>
                                ...
                                <p className="text-xs text-slate-500">
                                    Lifecycle of this report from submission to resolution.
                                </p>
                            </CardHeader>
                            <CardContent>
                                                ...
                                                <div>
                                                    ...
                                                    <p
                                                        className={`mt-0.5 text-xs ${
                                                            step.reached ? 'text-slate-500' : 'text-slate-400'
                                                        }`}
                                                    >
                                                        {step.description}
                                                    </p>
