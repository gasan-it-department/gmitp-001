...
export const CommunityReportTable = () => {
    ...
    return (
        <div className="flex h-full flex-col">
            ...
            <div className="my-5 flex items-center justify-between">
                ...
                {/* <CommunityReportHeader onSearch={() => {}} onFilterButtonClicked={() => {}} /> */}
            </div>
                ...
                <Table className="min-w-full table-auto">
                    ...
                    <TableBody>
                        {communityReportsList.length === 0 ? (
                            <AdminEmptyListItem colSpan={7} title="No community reports yet" message="Community reports will appear here." />
                        ) : (
