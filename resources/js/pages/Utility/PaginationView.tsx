...
const PaginationView: React.FC<PaginationProps> = ({ currentPage, totalPages, onPageChange, maxVisible = 9 }) => {
    ...
    if (totalPages <= maxVisible) {
        ...
        pages = ([1, '...'] as (number | string)[]).concat(Array.from({ length: 5 }, (_, i) => totalPages - 4 + i));
    } else {
