            ...
            <DialogContent className="overflow-hidden rounded-2xl border-0 p-0 shadow-2xl sm:max-w-[450px]">
                <div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6 bg-slate-50/30 px-6 py-6">
                        ...
                        {/* Active Toggle Card */}
                        <div
                            className={`flex items-center justify-between rounded-xl border p-4 transition-all duration-300 ${data.is_active ? 'border-blue-200 bg-blue-50/50 shadow-sm' : 'border-slate-200 bg-white'
                                } `}
                        >
