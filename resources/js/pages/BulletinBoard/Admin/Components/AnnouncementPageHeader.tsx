...
import { Filter, List, PlusIcon, SortAsc, SortAscIcon, SortDescIcon } from 'lucide-react';
...
export default function AnnouncementPageHeader({ className, onAddNewButtonClicked, onFilterButtonClicked, onSearch }: Props) {
    return (
