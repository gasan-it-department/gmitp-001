        ...
        <div className="relative overflow-hidden bg-[#f8faf9]">
            <section className="relative min-h-[calc(100vh-6rem)] overflow-hidden border-b border-[#d9e2df] bg-[#f8faf9]">
                <img
                    ...
                    alt=""
                    aria-hidden="true"
                    className="pointer-events-none absolute left-1/2 top-1/2 h-[32rem] w-[32rem] -translate-x-1/2 -translate-y-1/2 object-contain opacity-[0.06] sm:h-[42rem] sm:w-[42rem]"
                />
                ...
                <div className="relative mx-auto flex min-h-[calc(100vh-6rem)] max-w-7xl flex-col justify-center px-4 py-16 sm:px-6 lg:px-8">
                    ...
                    >
                        <div className="inline-flex items-center gap-2 rounded-full border border-slate-200 bg-white px-4 py-2 text-xs font-bold uppercase tracking-widest text-slate-900 shadow-sm">
                            <ShieldCheck className="h-4 w-4 text-slate-700" />
                            Serbisyong Bayan, Isang Portal
                        </div>

                        <div className="space-y-5">
                            <h1 className="text-4xl font-black leading-tight tracking-tight text-[#102a26] sm:text-5xl lg:text-7xl">
                        ...
                        <div className="flex flex-col items-center justify-center gap-3 sm:flex-row">
                            <a
                                href="#municipalities"
                                className="inline-flex h-12 items-center justify-center gap-2 rounded-md bg-slate-900 px-6 text-sm font-bold text-white shadow-sm transition-colors hover:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-slate-900 focus:ring-offset-2"
                            >
                                Piliin ang Bayan
                            ...
                            <a
                                href="#services"
                                className="inline-flex h-12 items-center justify-center gap-2 rounded-md border border-slate-200 bg-white px-6 text-sm font-bold text-slate-900 shadow-sm transition-colors hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-slate-900 focus:ring-offset-2"
                            >
                    ...
                    <div className="relative z-10 mx-auto mt-14 grid w-full max-w-3xl grid-cols-1 overflow-hidden rounded-lg border border-[#d9e2df] bg-white shadow-sm sm:grid-cols-3">
                        {serviceStats.map((item) => (
                            <div
                                key={item.label}
                                className="border-b border-[#d9e2df] px-6 py-5 text-center last:border-b-0 sm:border-b-0 sm:border-r sm:last:border-r-0"
                            >
                                <p className="text-2xl font-black text-slate-900">{item.value}</p>
                                <p className="mt-1 text-xs font-bold uppercase tracking-widest text-slate-500">{item.label}</p>
                            </div>
                        ))}
                    </div>
                </div>
            ...
            <section id="municipalities" className="relative bg-white px-4 py-20 sm:px-6 lg:px-8">
                <div className="mx-auto max-w-7xl">
                    <div className="mx-auto mb-12 max-w-3xl space-y-4 text-center">
                        ...
                        <p className="text-sm font-bold uppercase tracking-widest text-slate-700">Piliin ang Iyong Lokal na Pamahalaan</p>
            ...
            <section id="services" className="border-y border-[#d9e2df] bg-slate-100 px-4 py-20 sm:px-6 lg:px-8">
                <div className="mx-auto max-w-7xl">
                    <div className="mx-auto mb-12 max-w-3xl space-y-4 text-center">
                        <p className="text-sm font-bold uppercase tracking-widest text-slate-700">Digital na Serbisyo</p>
