  ...
  "
                    ...
                    <div>
                        ...
                        <p className="text-sm text-orange-800/80 dark:text-orange-200/80">
                            Help your community by reporting problems around town.
                        </p>
                    </div>
                </div>
                ...
                <div className="mt-auto flex justify-end pt-6">
                    <Button
                        className="flex w-full sm:w-auto items-center justify-center gap-2 rounded-lg border-none  bg-gradient-to-r from-red-500 to-orange-500 
