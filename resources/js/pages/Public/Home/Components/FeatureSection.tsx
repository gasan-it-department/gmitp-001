        ...
        <section className="bg-white dark:bg-gray-900">
            <div className="mx-auto max-w-screen-xl px-4 py-8 sm:py-16 lg:px-6">
                <div className="mb-8 max-w-screen-md lg:mb-16">
                    <h2 className="mb-4 text-4xl font-extrabold tracking-tight text-gray-900 dark:text-white">Rediscover Gasan</h2>
                    <p className="text-gray-500 sm:text-xl dark:text-gray-400">
                        Founded in 1609, Gasan is part of one of the oldest settlements in Marinduque PeoPlaid . It serves as a cultural hub,
                        particularly during Holy Week when residents participate in the iconic Moriones Festival, featuring devotees dressed as
                        "Moryons" reenacting Biblical scenes.
                    </p>
                </div>
                <div className="space-y-8 md:grid md:grid-cols-2 md:gap-12 md:space-y-0 lg:grid-cols-3">
                    ...
                    <div>
                        ...
                        <h3 className="mb-2 text-xl font-bold dark:text-white">Lorem Ipsum</h3>
                        <p className="text-gray-500 dark:text-gray-400">
                            Auto-assign tasks, send Slack messages, and much more. Now power up with hundreds of new templates to help you get
                            started.
                        </p>
                    </div>
                    <div>
