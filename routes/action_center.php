    ...
    ->group(function () {
        ...
        Route::middleware(['municipalityContext', 'admin', 'permission:action_center.access'])
            ->group(function () {
                ...
                Route::post(
                    '/assistance-request/{assistanceRequestId}/authorize-cooldown-exception',
                    AuthorizeCooldownExceptionController::class,
                )->middleware('permission:action_center.requests.decide')
                    ->name('assistance.authorize-cooldown-exception');

                Route::get(
                    '/assistance-request/{assistanceRequestId}/cooldown-context',
                    GetAssistanceCooldownContextController::class,
                )->middleware('permission:action_center.requests.decide|action_center.requests.release')
                    ->name('assistance.cooldown-context');
