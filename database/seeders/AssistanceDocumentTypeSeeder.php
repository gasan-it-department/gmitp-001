    ...
    public function run(): void
    {
        ...
        $documents = [
            ...
            [
                ...
                'description' => 'Opisyal na kopya ng blotter o ulat mula sa himpilan ng pulisya tungkol sa insidenteng naging dahilan ng pangangailangan ng tulong.',
                'examples' => 'Police blotter entry or certified incident report',
                'sort_order' => 32,
            ],
            [
                'key' => 'police_certification',
                'label' => 'Police Certification',
                'description' => 'Sertipikasyon mula sa pulisya para sa mga insidenteng tulad ng pickpocketing, illegal recruitment, at iba pang kaugnay na pangyayari.',
                'examples' => 'Police certification for pickpocketing, illegal recruitment, or a related incident',
                'sort_order' => 34,
            ],
            [
                'key' => 'social_work_justification',
                'label' => 'Social Work Justification',
                'description' => 'Nakasulat na paliwanag o assessment ng social worker na nagpapatunay sa kalagayan at pangangailangan ng kliyente.',
                'examples' => 'Social case assessment or written justification prepared by an MSWDO social worker',
                'sort_order' => 36,
            ],
            [
                'key' => 'court_order_or_subpoena',
                'label' => 'Court Order / Subpoena',
                'description' => 'Opisyal na Court Order o Subpoena na may kaugnayan sa dahilan ng paglalakbay o kahilingan ng tulong.',
                'examples' => 'Court Order, Subpoena, or other court-issued directive',
                'sort_order' => 38,
            ],
            [
                'key' => 'med_abstract',
            ...
            [
                ...
                'description' => 'Xerox na kopya ng rehistradong Death Certificate na nagpapatunay sa pagkamatay ng taong paglalamayan.',
                'examples' => 'PSA Death Certificate or LCR-registered Death Certificate',
                'sort_order' => 60,
            ],
            [
                'key' => 'deceased_senior_citizen_id',
                'label' => 'Deceased Senior Citizen ID',
                'description' => 'Xerox na kopya ng Senior Citizen ID ng namatay. Kailangan lamang kapag senior citizen ang namatay.',
                'examples' => 'OSCA-issued Senior Citizen ID of the deceased',
                'sort_order' => 61,
            ],
            [
                'key' => 'proof_of_relationship_to_deceased',
                'label' => 'Proof of Relationship to the Deceased',
                'description' => 'Magpasa ng isa: Marriage Certificate kung asawa ang kukuha ng tulong, Birth Certificate kung anak, o orihinal na sertipiko mula sa barangay na nagsasaad ng relasyon sa namatay.',
                'examples' => 'Marriage Certificate, Birth Certificate, or Barangay Certification of Relationship',
                'sort_order' => 65,
            ],
            [
                'key' => 'burial_expense_receipt',
                'label' => 'Burial Expense Official Receipt / Sales Invoice',
                'description' => 'Orihinal na Official Receipt o Sales Invoice para sa gastos sa pagpapalibing na nagkakahalaga ng hindi bababa sa ₱4,000.00.',
                'examples' => 'Official Receipt or Sales Invoice issued by the funeral service provider',
                'sort_order' => 68,
            ],
            [
                ...
                'examples' => 'Contract of Services from the funeral home',
                'sort_order' => 70,
            ],
            [
                'key' => 'cert_enrollment',
